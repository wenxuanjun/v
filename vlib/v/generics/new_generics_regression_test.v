...
const expected_summsvc_generics = 'Summary for all V _test.v files: 108 failed, 167 passed, 275 total.'
const expected_summary_generics = 'Summary for all V _test.v files: 106 failed, 169 passed, 275 total.'
